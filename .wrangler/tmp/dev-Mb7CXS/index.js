    ...
    if (url.pathname === "/api/suggest" && request.method === "POST") {
      try {
        ...
        const budgetMap = {
          ...
          "2.5K\u20BA+": "en az 2500 TL ve \xFCzeri (premium/l\xFCks segment)"
        };
        const budgetDescription = budgetMap[butce] || butce;
        const systemPrompt = `Sen hediye dan\u0131\u015Fman\u0131s\u0131n. Yaln\u0131zca T\xDCRK\xC7E yan\u0131t ver. Sonu\xE7lar\u0131 sadece 5 maddelik numaral\u0131 liste olarak ver. KR\u0130T\u0130K KURAL: \xD6nerdi\u011Fin her hediyenin fiyat\u0131 kullan\u0131c\u0131n\u0131n belirtti\u011Fi b\xFCt\xE7e aral\u0131\u011F\u0131n\u0131n \u0130\xC7\u0130NDE olmal\u0131d\u0131r. B\xFCt\xE7enin alt\u0131nda veya \xFCst\xFCnde fiyat YAZMA.`;
        const userPrompt = `B\xFCt\xE7e (KES\u0130N UYULMALI): ${budgetDescription}.
Ya\u015F: ${yas}, Cinsiyet: ${cinsiyet}, Vesile: ${vesile}, Not: ${ekstraNot || "Yok"}, Kategori: ${spinKategorisi}.
Bu b\xFCt\xE7eye uygun SADECE 5 k\u0131sa hediye \xF6nerisi yap. Her madde: hediye ad\u0131, tahmini fiyat (${budgetDescription} aral\u0131\u011F\u0131nda), tek c\xFCmle a\xE7\u0131klama. Do\u011Frudan listeye ba\u015Fla.`;
        const messages = [
...
// .wrangler/tmp/bundle-X8bvgR/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-X8bvgR/middleware-loader.entry.ts
